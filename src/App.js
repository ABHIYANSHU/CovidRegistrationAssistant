...
function App() {
  ...
  const toggleButtonDarkStyleConfig = {
    backgroundColor: "black",
    borderRadius: "100%",
    color: "white",
    position: "absolute",
  ...
  const toggleButtonLightStyleConfig = {
  ...
  return (
      <div className="container"
        style={ isToggle ? darkStyleConfig : {}
      }>
      ...
      <button style={
        !(isToggle) ? toggleButtonDarkStyleConfig : toggleButtonLightStyleConfig
      }
        onClick={toggle} > Toggle
      </button>
      <div className="footer" style={
        isToggle ? darkStyleConfig : {}
      }>
